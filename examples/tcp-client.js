...
const BlueTCPClient = BlueRPC.Client.TCP;

/**
 * Initialize BlueRPC TCP client
 */
const client = new BlueTCPClient({
  host: '127.0.0.1', // BlueRPC server IP address
  port: '8889',      // BlueRPC server listening port
});

/**
 * TCP client also has the capability to handle connection events
